...
function print_ad() {
    ...
    <form name="printform" class="btn" action="'.$path.'print.php" method="post" target="printme" onsubmit="formpopup();">
	...
	<a id="print_ad" class="btn" href="#" onClick="formpopup();document.printform.submit();return false;"><i class="fa fa-print"></i> ' . __('Print item', 'print_ad') . '</a>
